module OpenTracing
  ...
  class Span
    ...
    def initialize(
      ...
      @span_context = SpanContext.new(id: OpenTracing.guid, trace_id: trace_id)
    ...
    def log(event: nil, timestamp: Time.now, **fields)
      ...
      record = {
        ...
        timestamp_micros: OpenTracing.micros(timestamp)
      }
    ...
    def finish(end_time: Time.now)
      if end_micros.nil?
        self.end_micros = OpenTracing.micros(end_time)
      end
